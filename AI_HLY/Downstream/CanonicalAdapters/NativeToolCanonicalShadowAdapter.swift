  ...
  static func project(
    ...
    let findings: [HanlinShadowFinding] = [
      ...
      .init(
        ...
        message:
          "The live ToolPresentationProfile remains authoritative and is represented only as an automatic hint."
      ),
    ]
    let descriptor = HanlinToolDescriptor(
      ...
      presentation: .init(
        ...
        executionPresentation: entry.presentationProfile.canonicalExecutionPresentation,
        embeddedPresentation: entry.presentationProfile.canonicalEmbeddedPresentation
      )
    )
