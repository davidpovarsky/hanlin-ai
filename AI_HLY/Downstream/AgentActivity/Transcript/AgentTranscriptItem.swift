...
struct AgentTranscriptItem: Codable, Hashable, Identifiable {
  ...
  init(from decoder: Decoder) throws {
    ...
    resultRendererKind = try container.decodeIfPresent(
      ToolResultRendererKind.self, forKey: .resultRendererKind)
