...
import * as sourceMapJs from '../../source-map-js/index.mjs';
...
let consumerCache;
function getConsumer(mapPath, sourceMap) {
    if (!consumerCache) {
...
function findInlineOrLinkedMapFromJs(jsPath) {
...
function loadAndExtractMap(mapPath, fallbackJsPath) {
    // check cache first
    if (!loadedSourceMaps) {
