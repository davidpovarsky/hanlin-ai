...
export const androidIconRenderingModeProperty = new Property({
...
export const iosBottomAccessoryProperty = new Property({
    name: 'iosBottomAccessory',
});
iosBottomAccessoryProperty.register(TabViewBase);
export const iosTabBarMinimizeBehaviorProperty = new Property({
...
export const iconFontFamilyProperty = new CssProperty({
    name: 'iconFontFamily',
