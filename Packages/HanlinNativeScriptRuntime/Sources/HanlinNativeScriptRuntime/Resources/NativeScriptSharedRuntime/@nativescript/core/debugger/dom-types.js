...
const percentLengthToStringLazy = lazy(() => PercentLength.convertToString);
const getSetPropertiesLazy = lazy(() => getSetProperties);
const getComputedCssValuesLazy = lazy(() => getComputedCssValues);
...
//# sourceMappingURL=dom-types.js.map