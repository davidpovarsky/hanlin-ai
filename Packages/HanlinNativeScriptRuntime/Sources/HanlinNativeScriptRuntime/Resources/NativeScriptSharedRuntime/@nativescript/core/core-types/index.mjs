...
(function (CoreTypes) {
    ...
    (function (HorizontalAlignment) {
        ...
        HorizontalAlignment.isValid = makeValidator(HorizontalAlignment.start, HorizontalAlignment.left, HorizontalAlignment.center, HorizontalAlignment.right, HorizontalAlignment.end, HorizontalAlignment.stretch);
    ...
    (function (CornerShape) {
        ...
        CornerShape.isValid = makeValidator(CornerShape.round, CornerShape.squircle);
        CornerShape.parse = makeParser(CornerShape.isValid);
    })(CornerShape = CoreTypes.CornerShape || (CoreTypes.CornerShape = {}));
    let AnimationCurve;
    ...
    })(LayoutDirection = CoreTypes.LayoutDirection || (CoreTypes.LayoutDirection = {}));
})(CoreTypes || (CoreTypes = {}));
/**
